...
For information on how to generate Ballerina code for Protocol Buffers definition, see [the gRPC user guide](https://ballerina.io/learn/write-a-grpc-service-with-ballerina/).
