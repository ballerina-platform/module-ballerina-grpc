...
public isolated client class helloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function sayHello(string|wrappers:ContextString req) returns string|grpc:Error {
        ...
        var payload = check self.grpcClient->executeSimpleRPC("helloWorld/sayHello", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
        return result.toString();
    }

    isolated remote function sayHelloContext(string|wrappers:ContextString req) returns wrappers:ContextString|grpc:Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
