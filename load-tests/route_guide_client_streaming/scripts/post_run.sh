...
export scriptsDir="/home/ballerina/module-ballerina-grpc/load-tests/route_guide_client_streaming/scripts"
export resultsDir="/home/ballerina/module-ballerina-grpc/load-tests/route_guide_client_streaming/results"
...
bal run $scriptsDir/process_csv_output/ -- "gRPC Route Guide Client Streaming" 10 "$scriptsDir/ghz_output.csv" "$resultsDir/summary.csv" "1800"
