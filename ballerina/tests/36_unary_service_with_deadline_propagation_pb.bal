...
public isolated client class HelloWorld36S1Client {
    *AbstractClientEndpoint;
    ...
    isolated remote function call1(string|wrappers:ContextString req) returns string|Error {
    ...
    isolated remote function call1Context(string|wrappers:ContextString req) returns wrappers:ContextString|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
...
public isolated client class HelloWorld36S2Client {
    *AbstractClientEndpoint;
    ...
    isolated remote function call2(string|wrappers:ContextString req) returns string|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function call2Context(string|wrappers:ContextString req) returns wrappers:ContextString|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
