...
public isolated client class StructServiceClient {
    *AbstractClientEndpoint;
    ...
    isolated remote function getStructType1(string|wrappers:ContextString req) returns map<anydata>|Error {
    ...
    isolated remote function getStructType1Context(string|wrappers:ContextString req) returns struct:ContextStruct|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function getStructType2(string|wrappers:ContextString req) returns StructMsg|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function getStructType2Context(string|wrappers:ContextString req) returns ContextStructMsg|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function sendStructType1(map<anydata>|struct:ContextStruct req) returns string|Error {
        map<string|string[]> headers = {};
        map<anydata> message;
    ...
    isolated remote function sendStructType1Context(map<anydata>|struct:ContextStruct req) returns wrappers:ContextString|Error {
        map<string|string[]> headers = {};
        map<anydata> message;
        if req is struct:ContextStruct {
            message = req.content;
    ...
    isolated remote function sendStructType2Context(StructMsg|ContextStructMsg req) returns wrappers:ContextString|Error {
        map<string|string[]> headers = {};
        StructMsg message;
        if req is ContextStructMsg {
            message = req.content;
    ...
    isolated remote function exchangeStructType1(map<anydata>|struct:ContextStruct req) returns map<anydata>|Error {
        map<string|string[]> headers = {};
        map<anydata> message;
        if req is struct:ContextStruct {
            message = req.content;
    ...
    isolated remote function exchangeStructType1Context(map<anydata>|struct:ContextStruct req) returns struct:ContextStruct|Error {
        map<string|string[]> headers = {};
        map<anydata> message;
        if req is struct:ContextStruct {
            message = req.content;
    ...
    isolated remote function serverStreamStructType1(map<anydata>|struct:ContextStruct req) returns stream<map<anydata>, error?>|Error {
        map<string|string[]> headers = {};
        map<anydata> message;
        if req is struct:ContextStruct {
            message = req.content;
    ...
    isolated remote function serverStreamStructType1Context(map<anydata>|struct:ContextStruct req) returns struct:ContextStructStream|Error {
        map<string|string[]> headers = {};
        map<anydata> message;
        if req is struct:ContextStruct {
            message = req.content;
...
public client class ClientStreamStructType1StreamingClient {
    ...
    isolated remote function sendContextStruct(struct:ContextStruct message) returns Error? {
        return self.sClient->send(message);
    }
    ...
    isolated remote function receiveContextStruct() returns struct:ContextStruct|Error? {
        var response = check self.sClient->receive();
        if response is () {
            return response;
        } else {
...
public client class StructServiceStructCaller {
    ...
    isolated remote function sendContextStruct(struct:ContextStruct response) returns Error? {
        return self.caller->send(response);
    }
