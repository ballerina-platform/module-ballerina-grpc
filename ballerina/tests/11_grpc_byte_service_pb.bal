...
public isolated client class byteServiceClient {
    *AbstractClientEndpoint;
    ...
    isolated remote function checkBytes(byte[]|wrappers:ContextBytes req) returns byte[]|Error {
    ...
    isolated remote function checkBytesContext(byte[]|wrappers:ContextBytes req) returns wrappers:ContextBytes|Error {
        map<string|string[]> headers = {};
        byte[] message;
        if req is wrappers:ContextBytes {
            message = req.content;
...
const string ROOT_DESCRIPTOR_11_GRPC_BYTE_SERVICE = "";
