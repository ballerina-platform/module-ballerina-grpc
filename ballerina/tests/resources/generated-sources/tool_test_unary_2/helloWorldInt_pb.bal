...
public isolated client class helloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function hello(int|ContextInt req) returns (int|grpc:Error) {
    ...
    isolated remote function helloContext(int|ContextInt req) returns (ContextInt|grpc:Error) {
        map<string|string[]> headers = {};
        int message;
        if (req is ContextInt) {
            message = req.content;
