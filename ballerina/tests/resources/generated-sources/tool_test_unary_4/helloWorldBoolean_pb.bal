...
public isolated client class helloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function hello(boolean|ContextBoolean req) returns (boolean|grpc:Error) {
    ...
    isolated remote function helloContext(boolean|ContextBoolean req) returns (ContextBoolean|grpc:Error) {
        map<string|string[]> headers = {};
        boolean message;
        if (req is ContextBoolean) {
            message = req.content;
