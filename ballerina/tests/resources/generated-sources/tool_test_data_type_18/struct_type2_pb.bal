...
public isolated client class StructHandlerClient {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function unaryCall(map<anydata>|ContextStruct req) returns (map<anydata>|grpc:Error) {
    ...
    isolated remote function unaryCallContext(map<anydata>|ContextStruct req) returns (ContextStruct|grpc:Error) {
        map<string|string[]> headers = {};
        map<anydata> message;
        if (req is ContextStruct) {
            message = req.content;
    ...
    isolated remote function serverStreaming(map<anydata>|ContextStruct req) returns stream<map<anydata>, grpc:Error?>|grpc:Error {
        map<string|string[]> headers = {};
        map<anydata> message;
        if (req is ContextStruct) {
            message = req.content;
    ...
    isolated remote function serverStreamingContext(map<anydata>|ContextStruct req) returns ContextStructStream|grpc:Error {
        map<string|string[]> headers = {};
        map<anydata> message;
        if (req is ContextStruct) {
            message = req.content;
...
public client class ClientStreamingStreamingClient {
    ...
    isolated remote function receiveContextStruct() returns ContextStruct|grpc:Error? {
        var response = check self.sClient->receive();
        if response is () {
            return response;
        } else {
...
const string ROOT_DESCRIPTOR = "";
