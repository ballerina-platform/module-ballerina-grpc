...
public client class HelloStreamingClient {
    ...
    isolated remote function sendContextFloat(ContextFloat message) returns grpc:Error? {
        return self.sClient->send(message);
    }
