...
public isolated client class HelloWorld50Client {
    *AbstractClientEndpoint;
    ...
    public isolated function init(string url, *ClientConfiguration config) returns Error? {
        ...
        check self.grpcClient.initStub(self, ROOT_DESCRIPTOR_50_BIDI_CALLER_CANCEL_STATUS, getDescriptorMap50BidiCallerCancelStatus());
    }
    ...
    isolated remote function checkCancellationContext() returns wrappers:ContextBoolean|Error {
        empty:Empty message = {};
        map<string|string[]> headers = {};
        var payload = check self.grpcClient->executeSimpleRPC("HelloWorld50/checkCancellation", message, headers);
...
const string ROOT_DESCRIPTOR_50_BIDI_CALLER_CANCEL_STATUS = "";

public isolated function getDescriptorMap50BidiCallerCancelStatus() returns map<string> {
