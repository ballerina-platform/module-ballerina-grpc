...
public isolated client class AnonService1Client {
    *AbstractClientEndpoint;
    ...
    isolated remote function hello1(string|wrappers:ContextString req) returns string|Error {
    ...
    isolated remote function hello1Context(string|wrappers:ContextString req) returns wrappers:ContextString|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function hello2(string|wrappers:ContextString req) returns string|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function hello2Context(string|wrappers:ContextString req) returns wrappers:ContextString|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
...
public isolated client class AnonService2Client {
    *AbstractClientEndpoint;
    ...
    isolated remote function hello2(string|wrappers:ContextString req) returns stream<string, error?>|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function hello2Context(string|wrappers:ContextString req) returns wrappers:ContextStringStream|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
