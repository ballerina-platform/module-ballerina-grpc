...
public isolated client class helloWorld53Client {
    *AbstractClientEndpoint;
    ...
    isolated remote function hello53(string|wrappers:ContextString req) returns stream<string, error?>|Error {
    ...
    isolated remote function hello53Context(string|wrappers:ContextString req) returns wrappers:ContextStringStream|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
...
const string ROOT_DESCRIPTOR_53_SERVER_STREAMING_NEGATIVE = "";
