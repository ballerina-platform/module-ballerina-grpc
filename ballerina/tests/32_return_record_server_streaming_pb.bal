...
public isolated client class HelloWorld32Client {
    *AbstractClientEndpoint;
    ...
    isolated remote function sayHello(SampleMsg32|ContextSampleMsg32 req) returns stream<SampleMsg32, Error?>|Error {
    ...
    isolated remote function sayHelloContext(SampleMsg32|ContextSampleMsg32 req) returns ContextSampleMsg32Stream|Error {
        map<string|string[]> headers = {};
        SampleMsg32 message;
        if req is ContextSampleMsg32 {
            message = req.content;
        ...
        SampleMsg32Stream outputStream = new SampleMsg32Stream(result);
        return {content: new stream<SampleMsg32, Error?>(outputStream), headers: respHeaders};
    }
}
