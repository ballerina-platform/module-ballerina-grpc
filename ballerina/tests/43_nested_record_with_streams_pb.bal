...
public isolated client class NestedMsgServiceClient {
    *AbstractClientEndpoint;
    ...
    isolated remote function nestedMsgUnary(string|wrappers:ContextString req) returns NestedMsg|Error {
    ...
    isolated remote function nestedMsgUnaryContext(string|wrappers:ContextString req) returns ContextNestedMsg|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function nestedMsgServerStreaming(string|wrappers:ContextString req) returns stream<NestedMsg, Error?>|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function nestedMsgServerStreamingContext(string|wrappers:ContextString req) returns ContextNestedMsgStream|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
        ...
        NestedMsgStream outputStream = new NestedMsgStream(result);
        return {content: new stream<NestedMsg, Error?>(outputStream), headers: respHeaders};
    }
