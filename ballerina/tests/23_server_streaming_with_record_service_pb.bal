...
public isolated client class helloWorldServerStreamingClient {
    *AbstractClientEndpoint;
    ...
    public isolated function init(string url, *ClientConfiguration config) returns Error? {
        ...
        check self.grpcClient.initStub(self, ROOT_DESCRIPTOR_23_SERVER_STREAMING_WITH_RECORD_SERVICE, getDescriptorMap23ServerStreamingWithRecordService());
    }

    isolated remote function lotsOfReplies(HelloRequest|ContextHelloRequest req) returns stream<HelloResponse, Error?>|Error {
    ...
    isolated remote function lotsOfRepliesContext(HelloRequest|ContextHelloRequest req) returns ContextHelloResponseStream|Error {
        map<string|string[]> headers = {};
        HelloRequest message;
        if req is ContextHelloRequest {
            message = req.content;
        ...
        HelloResponseStream outputStream = new HelloResponseStream(result);
        return {content: new stream<HelloResponse, Error?>(outputStream), headers: respHeaders};
    }
}
...
const string ROOT_DESCRIPTOR_23_SERVER_STREAMING_WITH_RECORD_SERVICE = "";

public isolated function getDescriptorMap23ServerStreamingWithRecordService() returns map<string> {
