...
public isolated client class DurationHandlerClient {
    *AbstractClientEndpoint;
    ...
    public isolated function init(string url, *ClientConfiguration config) returns Error? {
        ...
        check self.grpcClient.initStub(self, ROOT_DESCRIPTOR_49_DURATION, getDescriptorMap49Duration());
    }

    isolated remote function unaryCall1(string|wrappers:ContextString req) returns time:Seconds|Error {
    ...
    isolated remote function unaryCall1Context(string|wrappers:ContextString req) returns duration:ContextDuration|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function serverStreaming(string|wrappers:ContextString req) returns stream<time:Seconds, error?>|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function serverStreamingContext(string|wrappers:ContextString req) returns duration:ContextDurationStream|Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
...
public client class ClientStreamingStreamingClient {
    ...
    isolated remote function sendContextDuration(duration:ContextDuration message) returns Error? {
        return self.sClient->send(message);
    }
...
public client class DurationHandlerDurationCaller {
    ...
    isolated remote function sendContextDuration(duration:ContextDuration response) returns Error? {
        return self.caller->send(response);
    }
...
const string ROOT_DESCRIPTOR_49_DURATION = "";

public isolated function getDescriptorMap49Duration() returns map<string> {
