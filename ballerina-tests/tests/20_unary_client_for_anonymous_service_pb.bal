...
public isolated client class AnonService1Client {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, ROOT_DESCRIPTOR_20_UNARY_CLIENT_FOR_ANONYMOUS_SERVICE, getDescriptorMap20UnaryClientForAnonymousService());
    }

    isolated remote function hello1(string|wrappers:ContextString req) returns string|grpc:Error {
    ...
    isolated remote function hello1Context(string|wrappers:ContextString req) returns wrappers:ContextString|grpc:Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function hello2(string|wrappers:ContextString req) returns string|grpc:Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
    ...
    isolated remote function hello2Context(string|wrappers:ContextString req) returns wrappers:ContextString|grpc:Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
...
public isolated client class AnonService2Client {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function hello2(string|wrappers:ContextString req) returns stream<string, grpc:Error?>|grpc:Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
        ...
        var payload = check self.grpcClient->executeServerStreaming("AnonService2/hello2", message, headers);
    ...
    isolated remote function hello2Context(string|wrappers:ContextString req) returns wrappers:ContextStringStream|grpc:Error {
        map<string|string[]> headers = {};
        string message;
        if req is wrappers:ContextString {
            message = req.content;
...
public isolated client class AnonService3Client {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function hello2() returns Hello2StreamingClient|grpc:Error {
        grpc:StreamingClient sClient = check self.grpcClient->executeClientStreaming("AnonService3/hello2");
...
public isolated client class AnonService4Client {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function hello2() returns Hello2StreamingClient|grpc:Error {
        grpc:StreamingClient sClient = check self.grpcClient->executeBidirectionalStreaming("AnonService4/hello2");
        return new Hello2StreamingClient(sClient);
    }
}
...
const string ROOT_DESCRIPTOR_20_UNARY_CLIENT_FOR_ANONYMOUS_SERVICE = "";

public isolated function getDescriptorMap20UnaryClientForAnonymousService() returns map<string> {
