...
public isolated client class helloWorldWithReservedNamesClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, ROOT_DESCRIPTOR_HELLOWORLDWITHRESERVEDNAMES, getDescriptorMapHelloWorldWithReservedNames());
    }
    ...
    isolated remote function hello(HelloRequest|ContextHelloRequest req) returns HelloResponse|grpc:Error {
        ...
        var _ = check self.grpcClient->executeSimpleRPC("helloWorldWithReservedNames/hello", message, headers);
    ...
    isolated remote function bye(ByeRequest|ContextByeRequest req) returns ByeResponse|grpc:Error {
        ...
        var _ = check self.grpcClient->executeSimpleRPC("helloWorldWithReservedNames/bye", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
...
const string ROOT_DESCRIPTOR_HELLOWORLDWITHRESERVEDNAMES = "";

public isolated function getDescriptorMapHelloWorldWithReservedNames() returns map<string> {
