...
public isolated client class HelloWorld3Client {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function testIntArrayInput(TestInt|ContextTestInt req) returns int|grpc:Error {
        ...
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testIntArrayInput", message, headers);
    ...
    isolated remote function testStringArrayInput(TestString|ContextTestString req) returns string|grpc:Error {
        ...
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testStringArrayInput", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
    ...
    isolated remote function testFloatArrayInput(TestFloat|ContextTestFloat req) returns float|grpc:Error {
        ...
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testFloatArrayInput", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
        return <float>result;
    }
    ...
    isolated remote function testBooleanArrayInput(TestBoolean|ContextTestBoolean req) returns boolean|grpc:Error {
        ...
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testBooleanArrayInput", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
    ...
    isolated remote function testStructArrayInput(TestStruct|ContextTestStruct req) returns string|grpc:Error {
        ...
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testStructArrayInput", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
        return result.toString();
    }
    ...
    isolated remote function testIntArrayOutput() returns TestInt|grpc:Error {
        empty:Empty message = {};
        map<string|string[]> headers = {};
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testIntArrayOutput", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
    ...
    isolated remote function testStringArrayOutput() returns TestString|grpc:Error {
        empty:Empty message = {};
        map<string|string[]> headers = {};
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testStringArrayOutput", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
    ...
    isolated remote function testFloatArrayOutput() returns TestFloat|grpc:Error {
        empty:Empty message = {};
        map<string|string[]> headers = {};
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testFloatArrayOutput", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
    ...
    isolated remote function testBooleanArrayOutput() returns TestBoolean|grpc:Error {
        empty:Empty message = {};
        map<string|string[]> headers = {};
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testBooleanArrayOutput", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
    ...
    isolated remote function testStructArrayOutput() returns TestStruct|grpc:Error {
        empty:Empty message = {};
        map<string|string[]> headers = {};
        var _ = check self.grpcClient->executeSimpleRPC("grpcservices.HelloWorld3/testStructArrayOutput", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
