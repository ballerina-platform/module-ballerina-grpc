...
public isolated client class helloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, ROOT_DESCRIPTOR_HELLOWORLDWITHENUM, getDescriptorMapHelloWorldWithEnum());
    }
    ...
    isolated remote function bye(ByeRequest|ContextByeRequest req) returns ByeResponse|grpc:Error {
        ...
        var _ = check self.grpcClient->executeSimpleRPC("helloWorld/bye", message, headers);
        [anydata, map<string|string[]>] [result, _] = payload;
...
const string ROOT_DESCRIPTOR_HELLOWORLDWITHENUM = "";

public isolated function getDescriptorMapHelloWorldWithEnum() returns map<string> {
