...
public const string SERVICE1_DESC = "";
...
public isolated client class MyService1Client {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function call2(Message2|ContextMessage2 req) returns Message2|grpc:Error {
        map<string|string[]> headers = {};
        Message2 message;
    ...
    isolated remote function call2Context(Message2|ContextMessage2 req) returns ContextMessage2|grpc:Error {
        map<string|string[]> headers = {};
        Message2 message;
        if req is ContextMessage2 {
            message = req.content;
