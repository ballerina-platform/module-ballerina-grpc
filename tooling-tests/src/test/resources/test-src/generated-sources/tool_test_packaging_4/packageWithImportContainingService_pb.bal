...
public client class HelloWorldResMessageCaller {
    ...
    isolated remote function sendContextResMessage(message:ContextResMessage response) returns grpc:Error? {
        return self.caller->send(response);
    }
