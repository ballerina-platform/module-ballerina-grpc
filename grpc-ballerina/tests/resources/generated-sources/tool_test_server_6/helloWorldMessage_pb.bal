...
public client class helloWorldClient {
    ...
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function hello(HelloRequest req) returns stream<HelloResponse, grpc:Error?>|grpc:Error {
    ...
    isolated remote function helloContext(HelloRequest req) returns ContextHelloResponseStream|grpc:Error {
    ...
    isolated remote function bye(ByeRequest req) returns stream<ByeResponse, grpc:Error?>|grpc:Error {
    ...
    isolated remote function byeContext(ByeRequest req) returns ContextByeResponseStream|grpc:Error {

        var payload = check self.grpcClient->executeServerStreaming("helloWorld/bye", req);
        [stream<anydata, grpc:Error?>, map<string|string[]>][result, headers] = payload;
        ByeResponseStream outputStream = new ByeResponseStream(result);
        return {content: new stream<ByeResponse, grpc:Error?>(outputStream), headers: headers};
    }
...
isolated function getDescriptorMap() returns map<string> {
    return {
        "helloWorldMessage.proto":""
