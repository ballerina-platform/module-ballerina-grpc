...
public client class OneofFieldServiceClient {
    ...
    *AbstractClientEndpoint;
    ...
    isolated remote function hello(Request1 req, service object {} msgListener, map<string[]> headers = {}) returns (Error?) {
        return self.grpcClient->nonBlockingExecute("grpcservices.OneofFieldService/hello", req, msgListener, headers);
    }

    isolated remote function testOneofField(ZZZ req, service object {} msgListener, map<string[]> headers = {}) returns (Error?) {
