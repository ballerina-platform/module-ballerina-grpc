...
public function testStringValueReturnWithBasicAUth() {
    HelloWorld28BlockingClient helloWorldEp = new ("http://localhost:9118");
...
public client class HelloWorld28BlockingClient {
    ...
    *AbstractClientEndpoint;
    ...
    public isolated function init(string url, ClientConfiguration? config = ()) {
        ...
        checkpanic self.grpcClient.initStub(self, ROOT_DESCRIPTOR_28, getDescriptorMap28());
    }
    ...
    isolated remote function testStringValueReturn(string|ContextString req) returns ContextString|Error {
        ...
        [anydata, map<string|string[]>][result, requestHeaders] = check self.grpcClient->executeSimpleRPC("HelloWorld28/testStringValueReturn", message, headers);
